...
ActiveRecord::Schema.define(version: 20140504013837) do
  ...
  add_index "pinches", ["job_id"], name: "index_pinches_on_job_id"
  add_index "pinches", ["photo_id"], name: "index_pinches_on_photo_id"
